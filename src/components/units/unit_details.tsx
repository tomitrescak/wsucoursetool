          ...
          <Pane>
            ...
            <Expander title="Description" id="unitDescription">
              ...
              {unit.approachToLearning && (
                <TextEditor owner={unit} field="approachToLearning" label="Approach to Learning" />
              )}
            </Expander>

            {/* BLOCK PREREQUISITES */}
            <Pane elevation={2} padding={16} borderRadius={8} marginBottom={16} marginTop={16}>
              <PrerequisiteEditor owner={unit} unit={unit} state={state} />
            </Pane>
            ...
            <Pane marginTop={16} elevation={2} padding={16} borderRadius={8}>
              <OutcomeEditor acss={acs} owner={unit} state={state} />
            </Pane>
          </Pane>
        )}
